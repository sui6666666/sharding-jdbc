...
-- ----------------------------
DROP TABLE IF EXISTS `ds_1`.`loudong`;
CREATE TABLE `ds_1`.`loudong`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `ds_1`.`sys_dic`;
CREATE TABLE `ds_1`.`sys_dic`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `ds_1`.`user`;
...
-- ----------------------------
DROP TABLE IF EXISTS `ds_1`.`user_0`;
CREATE TABLE `ds_1`.`user_0`  (
  `id` bigint(0) NOT NULL,
  `city` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
DROP TABLE IF EXISTS `ds_1`.`user_1`;
CREATE TABLE `ds_1`.`user_1`  (
  `id` bigint(0) NOT NULL,
  `city` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
DROP TABLE IF EXISTS `ds_1`.`user_2`;
CREATE TABLE `ds_1`.`user_2`  (
  `id` bigint(0) NOT NULL,
  `city` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
