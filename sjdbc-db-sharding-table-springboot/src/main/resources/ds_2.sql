...
-- ----------------------------
DROP TABLE IF EXISTS `ds_2`.`loudong`;
CREATE TABLE `ds_2`.`loudong`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `ds_2`.`sys_dic`;
CREATE TABLE `ds_2`.`sys_dic`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `ds_2`.`user`;
CREATE TABLE `ds_2`.`user`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `ds_2`.`user_0`;
CREATE TABLE `ds_2`.`user_0`  (
  `id` bigint(0) NOT NULL,
  `city` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
DROP TABLE IF EXISTS `ds_2`.`user_1`;
CREATE TABLE `ds_2`.`user_1`  (
  `id` bigint(0) NOT NULL,
  `city` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
DROP TABLE IF EXISTS `ds_2`.`user_2`;
CREATE TABLE `ds_2`.`user_2`  (
  `id` bigint(0) NOT NULL,
  `city` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
